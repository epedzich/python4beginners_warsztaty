class CollatzSeq():
    def __init__(self, start_value):
        ...
        try:
            assert isinstance(self.start_value, int) and self.start_value >= 1
...
if __name__ == '__main__':
    ...
    assert list(CollatzSeq(27)) == [27, 82, 41, 124, 62, 31, 94, 47, 142, 71, 214, 107, 322, 161, 484, 242, 121, 364,
    ...
    assert list(CollatzSeq(12346789)) == [12346789, 37040368, 18520184, 9260092, 4630046, 2315023, 6945070, 3472535,
                                          10417606, 5208803, 15626410, 7813205, 23439616, 11719808, 5859904, 2929952,
                                          1464976, 732488, 366244, 183122, 91561, 274684, 137342, 68671, 206014, 103007,
                                          309022, 154511, 463534, 231767, 695302, 347651, 1042954, 521477, 1564432,
                                          782216, 391108, 195554, 97777, 293332, 146666, 73333, 220000, 110000, 55000,
                                          27500, 13750, 6875, 20626, 10313, 30940, 15470, 7735, 23206, 11603, 34810,
                                          17405, 52216, 26108, 13054, 6527, 19582, 9791, 29374, 14687, 44062, 22031,
                                          66094, 33047, 99142, 49571, 148714, 74357, 223072, 111536, 55768, 27884,
                                          13942, 6971, 20914, 10457, 31372, 15686, 7843, 23530, 11765, 35296, 17648,
                                          8824, 4412, 2206, 1103, 3310, 1655, 4966, 2483, 7450, 3725, 11176, 5588, 2794,
